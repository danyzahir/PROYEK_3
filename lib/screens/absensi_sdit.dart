...
import 'absensi_sdit_absen.dart';

class AbsensiSDIT extends StatelessWidget {
  final String username;

  const AbsensiSDIT({super.key, required this.username});
                    ...
                    _menuBox(
                      ...
                      () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => AbsensiSDITAbsen(
                              username: username,
                            ),
                          ),
                        );
