...
class NilaiSDITNilai extends StatefulWidget {
  ...
  @override
  State<NilaiSDITNilai> createState() => _NilaiSDITNilai();
}

class _NilaiSDITNilai extends State<NilaiSDITNilai> {
                ...
                child: Column(
                  children: [
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => NilaiEditScreen(
                    ...
                    for (int i = 0; i < siswa.length; i++)
                      _buildInputRow(i, siswa[i], screenWidth),
                  ],
                ),
              ),
  ...
  Widget _buildInputRow(
      int index, Map<String, dynamic> data, double screenWidth) {
    return Container(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            ...
            child: Center(
              child: Text(
                '', // Kosongkan rata-rata untuk sementara
                style: TextStyle(fontSize: screenWidth * 0.035),
              ),
            ),
          ),
